defmodule Mix.Tasks.Docs.Epub do
  use Mix.Task

  @shortdoc "Generate EPUB documentation for the project"
  @recursive true

  @moduledoc """
  Uses ExDoc to generate an EPUB file from the docstrings extracted from
  ...
  * `:main` - main page of the documentation. It may be a module or a generated page,
  ...
  def run(args, config \\ Mix.Project.config, generator \\ &ExDoc.generate_docs/3) do
    ...
    options = Dict.put(options, :formatter, ExDocEPUB.Formatter.EPUB)
